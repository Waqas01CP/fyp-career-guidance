...
| Rationale documentation | docs/rationale/ folder. One file per major component. Written AFTER component is 100% complete and committed — never during or before. Architecture Chat checks and fills gaps after each completion. Files are NOT authoritative — CLAUDE.md and code win on conflict. See ARCHITECTURE_CHAT_INSTRUCTIONS_v2.md. |
