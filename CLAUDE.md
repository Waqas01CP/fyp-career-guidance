...
*CLAUDE.md v2.7 — May 2026 (LLM library rule scope clarified — langchain_google_genai applies to agents/ nodes only, not standalone scripts; google.generativeai permitted in backend/scripts/ when no LangGraph or FastAPI dependency exists)*